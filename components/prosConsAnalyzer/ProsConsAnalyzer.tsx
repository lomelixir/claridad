    ...
    <div className="flex justify-center w-full p-6">
      <div className="w-full max-w-6xl">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {/* Panel de entrada - Título y argumentos */}
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white white:bg-gray-800 rounded-xl shadow-lg p-6">
              ...
              <input
                ...
                placeholder="Ej: Cambiar de trabajo, Mudarme a otra ciudad, Iniciar un proyecto..."
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className={`flex-3 py-3 rounded-lg font-semibold transition-all ${
                  decisionTitle.trim()
              ...
              <button
                ...
                className="flex-2 py-3 rounded-lg border border-gray-300  
